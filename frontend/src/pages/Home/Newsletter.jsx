  ...
  return (
    <section className="py-12 sm:py-20 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto flex flex-col items-center tracking-wider">
        <h2 className="text-2xl sm:text-4xl font-light uppercase tracking-wider text-black text-center">
          Get on the list
        </h2>

        <p className="mt-4 text-lg sm:text-2xl text-gray-500 text-center font-light">
          and be the first to shop new arrivals and exclusive promotions.
        </p>

        <form className="mt-10 sm:mt-16 w-full max-w-3xl flex flex-col gap-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <button
              type="submit"
              className="bg-pink-200 hover:bg-blue-200 transition duration-300 text-lg sm:text-2xl font-light text-black px-6 sm:px-8 py-4 sm:py-5 tracking-wider"
            >
              Subscribe Now
            </button>
          </div>
