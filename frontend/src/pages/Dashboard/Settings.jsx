      ...
      <div className="rounded-xl border border-gray-300 p-6 uppercase tracking-wider">
        ...
        <form onSubmit={handleChangePassword} className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-300 p-3 pr-11 text-base outline-none focus:border-black transition duration-300 rounded"
                required
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-black text-white p-3 uppercase text-base font-light border border-black hover:bg-white hover:text-black transition duration-300 disabled:opacity-50 rounded"
          >
